...
unset($__errorArgs, $__bag); ?>
                                ...
                                <select name="position" id="position" class="form-select">
                                    <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($position->id); ?>"
                                            <?php echo e($position->id == $employee->position_id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <?php if($employee->original_filename): ?>
                                    <p>Current CV: <a
                                            href="<?php echo e(route('employees.download', $employee->id)); ?>"><?php echo e($employee->original_filename); ?></a>
                                    </p>
                                <?php else: ?>
                                    <p>No CV uploaded</p>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\modul 10 framework\resources\views/employee/edit.blade.php ENDPATH**/ ?>