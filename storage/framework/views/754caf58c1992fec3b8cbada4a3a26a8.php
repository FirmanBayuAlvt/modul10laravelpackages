<div class="d-flex">
    ...
    <form action="<?php echo e(route('employees.destroy', ['employee' => $employee->id])); ?>" method="POST" class="d-inline">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\firma\modul_8\resources\views/employee/actions.blade.php ENDPATH**/ ?>